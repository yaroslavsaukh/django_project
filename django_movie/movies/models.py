...
class Movie(models.Model):
    ...
    year = models.PositiveSmallIntegerField("Дата виходу", default=2021)
    ...
    budget = models.PositiveIntegerField("Бюджет", default=0, help_text="Сума в доларах")
    fees_in_usa = models.PositiveIntegerField("Збори в США", default=0, help_text="Сума в доларах")
    fees_in_world = models.PositiveIntegerField("Збори у світі", default=0, help_text="Сума в доларах")
